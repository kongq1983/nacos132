...
public class LocalConfigInfoProcessor {
    ...
    public static String getFailover(String serverName, String dataId, String group, String tenant) {
        File localPath = getFailoverFile(serverName, dataId, group, tenant); // 本地缓存文件
    ...
    public static void saveSnapshot(String envName, String dataId, String group, String tenant, String config) {
        if (!SnapShotSwitch.getIsSnapShot()) {
            return;
        } // C:\Users\kongqi\nacos\config\fixed-172.16.5.1_8848-testid_nacos\snapshot-tenant\testid\test\${dataId}
    ...
    static File getFailoverFile(String serverName, String dataId, String group, String tenant) {
        File tmp = new File(LOCAL_SNAPSHOT_PATH, serverName + "_nacos"); // 默认用户目录 System.getProperty("user.home")+"/nacos/config"
